...
import Config.User;
import adminDashboard.profilesInternal;
import authentication.LogIn;
import java.awt.Color;
import javax.swing.JOptionPane;


public class captainDash extends javax.swing.JFrame {
    ...
    private void showProfile() {
        capProfileInternal prof = new capProfileInternal();
        mydesktop.add(prof);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(captainDash.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new captainDash().setVisible(true);
            }
        });
    }
